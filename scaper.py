...
with requests.session():
    ...
    payload = {"category":["adHoc","regular"],"cause":[],"sortOrder":"Relevance","tdr":[],"opening":[],"suitability":[],"skill":[],"organizationId":[""]}
    p_auth = ("p_auth","hAg3vL6P")
    header = {
        "User-Agent":"Mozilla/5.0",
        'X-Requested-With': 'XMLHttpRequest'
        }
    page = requests.post(req, auth = p_auth, data=payload, headers=header)
